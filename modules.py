...
class MemoryModule(nn.Module):
    ...
    def reset_memory(self):
        self.last_update_time = nn.Parameter(torch.zeros(
    ...
    def backup_memory(self):
        ...
        """
        return self.memory.clone(), self.last_update_time.clone()
    ...
    def set_last_update_t(self, node_idxs, values):
        self.last_update_time[node_idxs] = values

    # For safety check
    def get_last_update(self, node_idxs):
        return self.last_update_time[node_idxs]
...
class MemoryOperation(nn.Module):
    ...
    def stick_feat_to_graph(self, g):
        ...
        g.ndata['timestamp'] = self.memory.last_update_time[g.ndata[dgl.NID]]
...
class EdgeGATConv(nn.Module):
    def __init__(self,
        ...
        # self.bn = nn.BatchNorm1d(self._out_feats)
